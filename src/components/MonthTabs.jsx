...
export default function MonthTabs({ tabs, activeDate, onTabClick, viewMode, onToggleView }) {
    ...
    if (isMobile) {
        return (
            <div className="mobile-month-nav">
                ...
                {onToggleView && (
                    <button
                        className="mobile-nav-btn mobile-toggle-btn"
                        onClick={onToggleView}
                        aria-label={viewMode === 'calendar' ? 'Ver lista' : 'Ver calendário'}
